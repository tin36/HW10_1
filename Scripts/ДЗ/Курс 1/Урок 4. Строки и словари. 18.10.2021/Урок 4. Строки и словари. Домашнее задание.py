...
#Блок добавления новых слов, пользователем при вводе контрольного слова
  if name == "admin":
    while True:
  ...
  if name.isalpha() and name != "admin":
      print(f'Отлично, {name}, давай начнем тренировку!')
      break
  else:
      print('Кажется, в имени пользователя есть цифры или пробелы')
